  ...
  return (
    <div className="w-full max-w-[400px]">
      ...
      <div className="bg-white p-8 rounded-xl shadow-[0_2px_10px_rgb(0,0,0,0.06)] border border-zinc-100">
        <h2 className="text-xl font-semibold text-zinc-950 mb-6">Login</h2>

        {isRegistered && (
          <div className="bg-green-50 border border-green-200 text-green-700 px-4 py-3 rounded-md mb-6 text-sm font-medium text-center">
      ...
      <div className="mt-8 text-center text-sm text-zinc-600">
        ...
        <Link href="/sign-up" className="font-medium text-zinc-900 hover:underline underline-offset-4">
          Signup
        </Link>
      </div>
      
      <div className="mt-4 text-center text-sm">
        <Link href="#" className="text-zinc-600 hover:underline underline-offset-4">
          Reset Password
        </Link>
      </div>
    </div>
