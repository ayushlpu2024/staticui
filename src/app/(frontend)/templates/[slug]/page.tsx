...
export default async function TemplateDetailPage({ params }: PageProps) {
  ...
  const PreviewComponent = dynamic(
    () => import(`../../../../registry/templates/${slug}.tsx`).catch(() => {
      return () => <div className="p-4 text-center text-zinc-500 border border-dashed rounded-md m-4">Template preview not available. Ensure the file exists in the registry.</div>
    }),
    { 
